...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/material-design-iconic-font/2.2.0/css/material-design-iconic-font.min.css">
  ...
  <div id="main">
    <div ref="Toolbar" id="Toolbar">
      <button id="btn-zoomout" class="btn"><i class="zmdi zmdi-minus-circle-outline"></i>
</button>
      <button id="btn-zoomin" class="btn"><i class="zmdi zmdi-plus-circle-o"></i></button>
...
export default {
  ...
  methods: {
    ...
    addStencil() {
      ...
      this.stencilRenderHandler(15, 20, this.arr, "load", 35);
